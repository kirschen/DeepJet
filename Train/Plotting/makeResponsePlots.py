...
makePlots_async(infile,['inclusive','G','UDS'],'jet_corr_pt/gen_pt_WithNu:gen_pt_WithNu',["gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=0.0&&TMath::Abs(jet_eta)<1.3","isPhysG &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=0.0&&TMath::Abs(jet_eta)<1.3","isUD+isS &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=0.0&&TMath::Abs(jet_eta)<1.3"],['black','green','red'],'resol_v_gen_Profile_UDSvsG_BB.pdf','gen Pt','response',False,True,0.9,1.0)


makePlots_async(infile,['inclusive','G','UDS'],'jet_corr_pt/gen_pt_WithNu:gen_pt_WithNu',["gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=1.3&&TMath::Abs(jet_eta)<2.5","isPhysG &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=1.3&&TMath::Abs(jet_eta)<2.5","isUD+isS &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=1.3&&TMath::Abs(jet_eta)<2.5"],['black','green','red'],'resol_v_gen_Profile_UDSvsG_EC.pdf','gen Pt','response',False,True,0.9,1.0)


makePlots_async(infile,['inclusive','G','UDS'],'jet_corr_pt/gen_pt_WithNu:gen_pt_WithNu',["gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=2.5&&TMath::Abs(jet_eta)<3.0","isPhysG &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=2.5&&TMath::Abs(jet_eta)<3.0","isUD+isS &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=2.5&&TMath::Abs(jet_eta)<3.0"],['black','green','red'],'resol_v_gen_Profile_UDSvsG_EE.pdf','gen Pt','response',False,True,0.9,1.0)

makePlots_async(infile,['inclusive','G','UDS'],'jet_corr_pt/gen_pt_WithNu:gen_pt_WithNu',["gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=3.0&&TMath::Abs(jet_eta)<5.2","isPhysG &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=3.0&&TMath::Abs(jet_eta)<5.2","isUD+isS &&  gen_pt_WithNu>30&&gen_pt_WithNu<300&&TMath::Abs(jet_eta)>=3.0&&TMath::Abs(jet_eta)<5.2"],['black','green','red'],'resol_v_gen_Profile_UDSvsG_HF.pdf','gen Pt','response',False,True,0.9,1.0)
